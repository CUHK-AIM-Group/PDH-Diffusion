...
from dataset import TransformedIterableDataset,TorchDataset
import random
...
class PyTorchEstimator(Estimator):
    ...
    def __init__(
        ...
        self._loader_generator.manual_seed(self.seed)
    ...
    def train_model(
        ...
        **kwargs,
        ...
        input_names.append('item_id')
        input_names.append('G')
        input_names.append('hqDq')
